...
contract PUNKYNFT is ERC721, ERC721URIStorage, Ownable, ERC721Enumerable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    mapping(uint256 => string) private _tokenURIs;

    constructor() ERC721("PUNKYNFT", "PNK") {}

    /**
        Set the base URI for storage.
    */
    ...
    */
    ...
    {
        require(_exists(tokenId), "ERC721Metadata: Token doesn't exist");
